...
public class ConceptPID2019 extends LinearOpMode {
        ...
        public void runOpMode() {
            ...
            motorExLeft = (DcMotorEx)hardwareMap.get(DcMotor.class, "Block_Lifter");
            ...
            motorExLeft.setTargetPosition(100 + startValue );
           ...
           PIDCoefficients pidOrig = motorExLeft.getPIDCoefficients(DcMotor.RunMode.RUN_TO_POSITION);
            ...
            motorExLeft.setTargetPosition(startValue );
            motorExLeft.setPower(0.3);
