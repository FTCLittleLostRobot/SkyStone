...
public class MecanumSkyStoneStateMachineV1 {

    Telemetry telemetry;
    MecanumEncoderMove moveRobot;
    ColorFinder colorFinder;
    MecanumSkyStoneStateMachineV1.RobotState state;
    ...
    public void init(Telemetry telemetry, MecanumMotor motors, ColorFinder colorFinder, GyroController gyro, boolean EndByWall, boolean isRed, HardwareMecanumBase robot ) {
        ...
        state = MecanumSkyStoneStateMachineV1.RobotState.Start;
    }
    ...
    {
        return (state == MecanumSkyStoneStateMachineV1.RobotState.Done);
    }
